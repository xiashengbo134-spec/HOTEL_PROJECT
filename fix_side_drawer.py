...
path = Path(r'07_SaaS_Workstation/purchase-order/order-management/hotel-order/pages/detail/side-drawer.html')
text = path.read_text(encoding='utf-8')

text = text.replace("""    .task-tab-list { display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 10px; }
    .task-tab-btn { display: flex; flex-direction: column; align-items: flex-start; gap: 6px; min-width: 250px; padding: 10px 12px; border: 1px solid var(--color-border-1); border-radius: 7px; background: #fff; color: var(--color-text-2); cursor: pointer; }
    .task-tab-btn.active { border-color: rgba(22, 93, 255, .28); background: rgba(22, 93, 255, .04); box-shadow: inset 0 0 0 1px rgba(22, 93, 255, .08); }
    .task-tab-title { font-size: 14px; font-weight: 600; color: var(--color-text-1); }
    .task-tab-meta { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
    .task-tab-time { color: var(--color-text-3); font-size: 12px; }
    .purchase-task-panel { display: none; }
    .purchase-task-panel.active { display: block; }""", """    .view-switch { display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 10px; }
    .view-card { display: flex; flex-direction: column; align-items: flex-start; gap: 8px; min-width: 220px; padding: 10px 12px; border: 1px solid var(--color-border-1); border-radius: 7px; background: #fff; color: var(--color-text-2); cursor: pointer; }
    .view-card.active { border-color: rgba(22, 93, 255, .28); background: rgba(22, 93, 255, .04); box-shadow: inset 0 0 0 1px rgba(22, 93, 255, .08); }
    .view-card-top { width: 100%; display: flex; align-items: center; justify-content: space-between; gap: 8px; }
    .view-card-title { font-size: 14px; font-weight: 600; color: var(--color-text-1); }
    .view-card-stats { display: inline-flex; align-items: center; gap: 6px; flex-wrap: wrap; }
    .view-stat { font-size: 12px; line-height: 18px; }
    .view-stat-success { color: var(--color-success); }
    .view-stat-fail { color: var(--color-danger); }
    .view-card-meta { width: 100%; display: flex; align-items: center; justify-content: space-between; gap: 8px; color: var(--color-text-3); font-size: 12px; }
    .view-room-count { color: var(--color-text-2); }
    .purchase-task-panel { display: block; }
    .purchase-task-panel.active { display: block; }""")

text = text.replace("""    .purchase-order-list { display: flex; flex-direction: column; gap: 10px; margin-top: 10px; }
  ...
  .purchase-more-grid .purchase-detail-item.no-label { grid-template-columns: minmax(0, 1fr); }
    ...
    .purchase-actions .btn { min-width: auto; padding: 0 12px; height: 32px; }""", """    .purchase-order-list { display: flex; flex-direction: column; gap: 10px; margin-top: 10px; }
    .purchase-order-item { border: 1px solid var(--color-border-2); border-radius: 7px; background: #fff; padding: 12px 14px; }
    .purchase-order-top { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; }
    .purchase-order-title-wrap { display: flex; flex-direction: column; gap: 8px; min-width: 0; }
    .purchase-order-title { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
...
new_section = """                    <div class=\"view-switch\">
            ...
            <div class=\"purchase-task-panel active\">
              <div class=\"purchase-order-list\">
                <div class=\"purchase-order-item\" data-view-group=\"2026-04-25-26\">
                  <div class=\"purchase-order-top\"><div class=\"purchase-order-title-wrap\"><div class=\"purchase-order-title\"><span class=\"source-badge\"><span class=\"source-platform\">艺</span><span class=\"source-channel\">艺龙-api</span></span><span class=\"purchase-order-no\">采购单号：PO-20260425-001</span></div></div><div class=\"purchase-actions\"><span class=\"tag tag-gray\">已取消</span></div></div>
                  <div class=\"purchase-order-main\"><div class=\"purchase-detail-grid\"><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">房型信息</div><div class=\"purchase-detail-value\">豪华大床房-双早</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">入离时间</div><div class=\"purchase-detail-value\">2026年4月25日 - 2026年4月26日</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">间夜</div><div class=\"purchase-detail-value\">2间 / 1晚</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">入住人</div><div class=\"purchase-detail-value\">张三</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">联系人</div><div class=\"purchase-detail-value\">李四 / 13800000001</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">取消规则</div><div class=\"purchase-detail-value\">入住前1天18:00前可免费取消，之后取消收取首晚房费。</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">创建时间</div><div class=\"purchase-detail-value\">2026-04-25 20:09:12</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">支付时间</div><div class=\"purchase-detail-value\">-</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">取消时间</div><div class=\"purchase-detail-value\">2026-04-25 20:10:07</div></div><div class=\"purchase-detail-item no-label\"><div class=\"purchase-detail-value\"><details class=\"purchase-more\"><summary>查看更多</summary><div class=\"purchase-more-grid\"><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">支付方式</div><div class=\"purchase-detail-value\">企业VCC预付</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">支付流水</div><div class=\"purchase-detail-value\">PAY-PO-20260425-001</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">优惠权益</div><div class=\"purchase-detail-value\">无优惠</div></div><div class=\"purchase-detail-item\"><div class=\"purchase-detail-label\">开票类型</div><div class=\"purchase-detail-value\">酒店开发票</div></div></div></details></div></div></div><div class=\"purchase-order-side\"><div class=\"purchase-amount-label\">订单金额</div><div class=\"purchase-amount-value\">¥432.00</div><details class=\"purchase-price-detail\"><summary>价格明细</summary><div class=\"purchase-price-list\"><div class=\"cost-row\"><div class=\"cost-row-label\">订单金额</div><div class=\"cost-row-value\">¥432.00</div></div><div class=\"cost-row\"><div class=\"cost-row-label\">优惠信息</div><div class=\"cost-row-value\">无优惠</div></div><div class=\"cost-row\"><div class=\"cost-row-label\">实付金额</div><div class=\"cost-row-value emphasis\">¥432.00</div></div></div></details></div></div>
...
text = re.sub(r'\s{20}<div class="task-tab-list">.*?\s{8}</section>', new_section + '\n\n        </section>', text, count=1, flags=re.S)
text = re.sub(r'<div class="modal-mask" id="purchaseFailureModal">.*?</div>\s*</div>\s*<div class="toast" id="toast"></div>', '  <div class="modal-mask" id="purchaseFailureModal">\n    <div class="modal">\n      <div class="modal-head"><div class="modal-title">采购失败原因明细</div><button class="btn" data-close-modal>关闭</button></div>\n      <div class="modal-body"><pre class="json-dialog-pre" id="purchaseFailureContent">{}</pre></div>\n    </div>\n  </div>\n\n  <div class="toast" id="toast"></div>', text, count=1, flags=re.S)
text = text.replace("""    document.querySelectorAll('[data-task-panel]').forEach(btn => btn.addEventListener('click', () => {
      document.querySelectorAll('[data-task-panel]').forEach(el => el.classList.remove('active'));
      document.querySelectorAll('.purchase-task-panel').forEach(panel => panel.classList.remove('active'));
      btn.classList.add('active');
      document.getElementById(btn.dataset.taskPanel).classList.add('active');
    }));""", """    document.querySelectorAll('[data-view]').forEach(btn => btn.addEventListener('click', () => {
      document.querySelectorAll('[data-view]').forEach(el => el.classList.remove('active'));
      btn.classList.add('active');
      const view = btn.dataset.view;
      document.querySelectorAll('.purchase-order-item[data-view-group]').forEach(item => {
        item.style.display = view === 'all' || item.dataset.viewGroup === view ? '' : 'none';
      });
    }));""")
text = text.replace("""    document.querySelectorAll('[data-modal]').forEach(btn => btn.addEventListener('click', () => {
      if (btn.dataset.modal === 'purchaseFailure') document.getElementById('purchaseFailureModal')?.classList.add('show');
    }));""", """    document.querySelectorAll('[data-modal]').forEach(btn => btn.addEventListener('click', () => {
      if (btn.dataset.modal === 'purchaseFailure') {
        const modal = document.getElementById('purchaseFailureModal');
        const contentEl = document.getElementById('purchaseFailureContent');
        if (contentEl) {
          try {
            const detail = btn.dataset.failureDetail ? JSON.parse(btn.dataset.failureDetail) : {};
            contentEl.textContent = JSON.stringify(detail, null, 2);
          } catch {
